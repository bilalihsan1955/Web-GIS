...
export default function PreviewPage() {
  ...
  const activeAdminId = (userRole === 'superadmin' && selectedCompanyId !== 'all') ? selectedCompanyId : (slug || undefined);
        ...
        <div className="flex items-center gap-2">
          ...
          {!hasValidCompany ? (
            <div className="flex flex-col items-end gap-3">
              ...
              <div className="bg-slate-900/95 backdrop-blur border border-amber-500/30 rounded-xl p-3 shadow-xl max-w-[280px] animate-in fade-in slide-in-from-top-2 duration-500">

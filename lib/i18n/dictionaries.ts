export const dictionaries = {
  id: {
    ...
    deleteCompanyPermanently: 'Hapus Perusahaan Permanen',
    dangerZone: 'Zona Bahaya — Tindakan Tidak Dapat Dibatalkan',
    cascadeDeleteWarning: 'Menghapus Pemilik Perusahaan ini akan menghapus secara permanen:',
    allGroupUsers: 'Semua pengguna dalam grup perusahaan ini',
    allSpatialNodes: 'Semua titik panorama 360° dan data peta',
    allLocations: 'Semua lokasi dan sektor',
    allUploadedImages: 'Semua gambar yang diunggah dari penyimpanan',
    companyProfile: 'Profil perusahaan, logo, dan slug',
    typeEmailToConfirm: 'Ketik alamat email untuk mengonfirmasi penghapusan:',
    
    // Duplicate Node Detection
    checkDuplicates: 'Cek Duplikat',
    duplicateNodesFound: 'Node Duplikat Terdeteksi',
    noDuplicatesFound: 'Tidak ada duplikat ditemukan.',
    noDuplicatesDesc: 'Semua node memiliki koordinat yang unik.',
    identicalNodes: 'node identik',
    duplicateGroups: 'grup duplikat',
    selectAllExceptFirst: 'Pilih semua kecuali pertama',
    deselectAll: 'Batal pilih semua',
    selectedForDeletion: 'terpilih untuk dihapus',
    deleteSelected: 'Hapus Terpilih',
    confirmBatchDelete: 'Konfirmasi Penghapusan Batch',
    batchDeleteWarning: 'Anda akan menghapus node beserta gambar dan lokasinya secara permanen. Tindakan ini tidak dapat dibatalkan.',
    deletingProgress: 'Menghapus',
    of: 'dari',
    locationLabel: 'Lokasi',
    byCoordinates: 'Berdasarkan Koordinat (Lat/Long)',
    byImage: 'Berdasarkan Gambar (URL)',
    sharedImageTag: 'Gambar Sama di Lokasi Lain',
    sameImageDifferentCoords: 'Gambar sama di koordinat berbeda',
  },
  en: {
    // Navigation / General
    back: 'Back',
    ...
    deleteCompanyPermanently: 'Delete Company Permanently',
    dangerZone: 'Danger Zone — Irreversible Action',
    cascadeDeleteWarning: 'Deleting this Company Owner will permanently remove:',
    allGroupUsers: 'All users in this company group',
    allSpatialNodes: 'All 360° panorama nodes and map data',
    allLocations: 'All locations and sections',
    allUploadedImages: 'All uploaded images from storage',
    companyProfile: 'Company profile, logo, and slug',
    typeEmailToConfirm: 'Type the email address to confirm deletion:',
    
    // Duplicate Node Detection
    checkDuplicates: 'Check Duplicates',
    duplicateNodesFound: 'Duplicate Nodes Detected',
    noDuplicatesFound: 'No duplicates found.',
    noDuplicatesDesc: 'All nodes have unique coordinates.',
    identicalNodes: 'identical nodes',
    duplicateGroups: 'duplicate groups',
    selectAllExceptFirst: 'Select all except first',
    deselectAll: 'Deselect all',
    selectedForDeletion: 'selected for deletion',
    deleteSelected: 'Delete Selected',
    confirmBatchDelete: 'Confirm Batch Deletion',
    batchDeleteWarning: 'You are about to permanently delete nodes along with their images and locations. This action cannot be undone.',
    deletingProgress: 'Deleting',
    of: 'of',
    locationLabel: 'Location',
    byCoordinates: 'By Coordinates (Lat/Long)',
    byImage: 'By Image (URL)',
    sharedImageTag: 'Shared Image Across Locations',
    sameImageDifferentCoords: 'Same image with different coordinates',
  }
};
